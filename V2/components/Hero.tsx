            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 mb-8 cursor-default shadow-sm">
                        ...
                        <span className="text-[12px] font-mono uppercase tracking-widest text-zinc-500 dark:text-zinc-400 font-medium">India's First Verified Legal AI</span>
                    </div>
                            ...
                            <div className="hidden md:flex w-64 bg-zinc-50 dark:bg-zinc-950 border-r border-zinc-200 dark:border-zinc-800 flex-col justify-between shrink-0 text-left">
                                <div>
                                    ...
                                    <div className="h-16 border-b border-zinc-200 dark:border-zinc-800 flex items-center px-5 gap-3">
                                        ...
                                        <span className="font-medium text-sm text-zinc-900 dark:text-white">Workspace</span>
                                        <ChevronRightIcon className="w-3.5 h-3.5 text-zinc-400 ml-auto" />
                                    </div>

                                    {/* Navigation Links */}
                                    <div className="p-3 space-y-1 mt-2">
                                        <div className="px-3 py-2 bg-white dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-700/50 rounded-lg flex items-center gap-3 text-sm font-medium text-zinc-900 dark:text-white shadow-sm cursor-pointer">
                                            <SparklesIcon className="w-4 h-4 text-blue-600" />
                                            Research AI
                                        </div>
                                        <div className="px-3 py-2 rounded-lg flex items-center gap-3 text-sm text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 cursor-pointer transition-colors group/nav">
                                    ...
                                    <div className="mt-6 px-5">
                                        <div className="text-xs font-medium text-zinc-400 uppercase tracking-wider mb-3">RECENT</div>
                                        <div className="space-y-3 pl-1">
                                            {[
                                                ...
                                                <div key={i} className="flex flex-col gap-0.5 cursor-pointer group/item relative pl-3 border-l border-zinc-200 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-600 transition-colors">
                                                    <span className="text-sm text-zinc-600 dark:text-zinc-300 group-hover/item:text-zinc-900 dark:group-hover/item:text-white transition-colors truncate">{item.title}</span>
                                ...
                                <div className="p-4 border-t border-zinc-200 dark:border-zinc-800">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="text-sm font-medium text-zinc-900 dark:text-white truncate">Aditya Verma</p>
                                ...
                                <div className="h-16 border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-between px-8 bg-white dark:bg-zinc-950 shrink-0">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className="hidden sm:flex items-center gap-3 px-3 py-2 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg min-w-[240px]">
                                            ...
                                            <span className="text-xs text-zinc-400">Search cases, acts...</span>
                                        ...
                                        <div className="flex gap-5 max-w-3xl group">
                                            ...
                                            <div className="space-y-4 w-full">
                                                <div className="bg-white dark:bg-zinc-900 p-6 md:p-8 rounded-3xl rounded-tl-none border border-zinc-200 dark:border-zinc-800 shadow-sm text-[15px] text-zinc-800 dark:text-zinc-200 leading-7 relative">
                                                    <p className="mb-6">
                                                        According to <strong className="text-zinc-900 dark:text-white font-medium bg-blue-50 dark:bg-blue-900/20 px-1 rounded border border-blue-100 dark:border-blue-800/30">Section 138 of the Negotiable Instruments Act, 1881</strong>, the dishonour of a cheque for insufficiency of funds is a criminal offence. The penalties prescribed are:
                                                    </p>
                                                    ...
                                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                                                        <div className="bg-zinc-50 dark:bg-zinc-950 p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 flex gap-4 hover:border-red-200 dark:hover:border-red-900/50 transition-colors">
                                                            ...
                                                            <div>
                                                                <div className="text-xs font-medium text-zinc-900 dark:text-white mb-1 uppercase tracking-wide">Imprisonment</div>
                                                                <div className="text-sm text-zinc-600 dark:text-zinc-300">Up to 2 years</div>
                                                            </div>
                                                        </div>
                                                        <div className="bg-zinc-50 dark:bg-zinc-950 p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 flex gap-4 hover:border-orange-200 dark:hover:border-orange-900/50 transition-colors">
                                                            ...
                                                            <div>
                                                                <div className="text-xs font-medium text-zinc-900 dark:text-white mb-1 uppercase tracking-wide">Monetary Fine</div>
                                                                <div className="text-sm text-zinc-600 dark:text-zinc-300">Up to twice the cheque amount</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="mt-6 border-t border-zinc-100 dark:border-zinc-800 pt-5">
                                                        <div className="flex items-center justify-between mb-4">
                                                            <p className="text-xs font-medium text-zinc-400 uppercase tracking-widest flex items-center gap-2">
                                                                <CheckBadgeIcon className="w-3.5 h-3.5 text-green-500" />
                                                                Verified Sources
                                                            </p>
                                                            <div className="flex gap-2">
                                                                <button className="text-xs font-medium text-blue-600 hover:text-blue-700 hover:underline">View Full Act</button>
                                                            </div>
                                                        </div>
                                                        <div className="bg-blue-50/50 dark:bg-blue-900/5 border border-blue-100 dark:border-blue-800/30 rounded-xl p-4 flex items-start gap-4 group/citation cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900/10 transition-all hover:shadow-sm">
                                                            ...
                                                            <div>
                                                                <h4 className="text-sm font-medium text-zinc-900 dark:text-white mb-1.5 group-hover/citation:text-blue-600 transition-colors">The Negotiable Instruments Act, 1881</h4>
